...
public class AngleFont {
	 ...
	 * @param red
	 *            Color of the font (Red)
	 * @param green
	 *            Color of the font (Green)
	 * @param blue
	 *            Color of the font (Blue)
	 * @param alpha
	 *            Color of the font (Alpha channel)
	 */
	public AngleFont(AngleSurfaceView view, float fontSize, Typeface typeface, int space, int red,
	 ...
	 *            Typeface
	 * @param charCount
	 *            Number of characters into font
	 * @param border
	 *            Border of every character
	 * @param space
	 *            Space between characters
	 * @param red
	 *            Color of the font (Red)
	 ...
	 *            Color of the font (Alpha channel)
	 */
	public AngleFont(AngleSurfaceView view, float fontSize, Typeface typeface, int charCount,
			int border, int space, int red, int green, int blue, int alpha) {
		mTextureEngine = view.getTextureEngine();
	 ...
	 *            Typeface
	 * @param chars
	 *            String with characters into font
	 * @param border
	 *            Border of every character
	 * @param space
	 *            Space between characters
	 ...
	 *            Color of the font (Alpha channel)
	 */
	public AngleFont(AngleSurfaceView view, float fontSize, Typeface typeface, char[] chars,
			int border, int space, int red, int green, int blue, int alpha) {
		mTextureEngine = view.getTextureEngine();
	 ...
	 *            Main AngleSurfaceView
	 * @param asset
	 *            FNT file (to load font from)
	 * @param resourceId
	 *            PNG file (to load font from)
	 * @param space
	 *            Space between characters
	 */
	...
	private void doInit(float fontSize, Typeface typeface, short charCount, short space, int red,
			int green, int blue, int alpha) {
		doInit(charCount);
		mSpace = space;
		mFontSize = fontSize;
	...
	/**
	 * Save texture to the root of the SD card using 2 files. 1 PNG with
	 * graphics and 1 FNT with data. Edit the PNG and use it as a drawable
	 * resource and put the FNT into asset folder to reload edited font.
	 * 
	 * @param fileName
	 */
	public void saveTo(String fileName) {
		...
		if (bitmap != null) {
			try {
				FileOutputStream stream = new FileOutputStream(SDCARD_PATH + fileName + ".png");
				...
				stream = new FileOutputStream(SDCARD_PATH + fileName + ".fnt");
	 ...
	 * 
	 * @param c
	 *            Index of the character in font character array
