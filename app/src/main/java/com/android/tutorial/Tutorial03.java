...
/**
 * Use FPSCounter class to see performance, put the Activity in full screen
 * (look in AndroidManifest.xml) and play with alpha >Veremos como usar
 * FPSCounter para ver el rendimiento, pondremos la Activity a pantalla completa
 * (mirar en AndroidManifest.xml) y jugaremos con el canal alfa
 * 
 * @author Ivan Pajuelo
 * 
 */
