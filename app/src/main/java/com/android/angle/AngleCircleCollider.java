...
public class AngleCircleCollider {
	...
	public boolean test(AngleCircleCollider otherCollider) {
		float dX = (otherCollider.mObject.mPosition.mX + otherCollider.mCenter.mX)
				- (mObject.mPosition.mX + mCenter.mX);
		float dY = (otherCollider.mObject.mPosition.mY + otherCollider.mCenter.mY)
				- (mObject.mPosition.mY + mCenter.mY);
	...
	protected void draw(GL10 gl) {
		...
		gl.glTranslatef(mObject.mPosition.mX + mCenter.mX, mObject.mPosition.mY
				+ mCenter.mY, 0.0f);
