...
public class AnglePhysicsEngine extends AngleObject {
	...
	protected void physics(float secondsElapsed) {
		for (int o = 0; o < mChildsCount; o++) {
			if (mChilds[o] instanceof AnglePhysicObject) {
				...
				// Gravity
				mChildO.mVelocity.mX += mChildO.mMass * mGravity.mX
						* secondsElapsed;
				mChildO.mVelocity.mY += mChildO.mMass * mGravity.mY
						* secondsElapsed;
	 ...
	 * .mY=mChildO.mVelocity.mY*AngleMainEngine.secondsElapsed;
	 * mChilds[c].mDelta
						...
						if (c != o) {
							if (mChilds[c] instanceof AnglePhysicObject) {
								...
								if (mChildO.collide(mChildC)) {
									mChildO.mPosition.mX -= mChildO.mDelta.mX;
									mChildO.mPosition.mY -= mChildO.mDelta.mY;
									mChildC.mDelta.mX = mChildC.mVelocity.mX
											* secondsElapsed;
									mChildC.mDelta.mY = mChildC.mVelocity.mY
											* secondsElapsed;
									break;
								}
							}
