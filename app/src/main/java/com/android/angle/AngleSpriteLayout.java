...
public class AngleSpriteLayout {
     ...
     */
    public AngleSpriteLayout(AngleSurfaceView view, int width, int height, int resourceId,
            int cropLeft, int cropTop, int cropWidth, int cropHeight, int frameCount,
            int frameColumns) {
        doInit(view, width, height, resourceId, cropLeft, cropTop, cropWidth, cropHeight,
    ...
    public void doInit(AngleSurfaceView view, int width, int height, Bitmap bitmap) {
        mTextureEngine = view.getTextureEngine();
        roTexture = mTextureEngine.createTextureFromBitmap(bitmap);
        roCropLeft = 0;
        roCropTop = 0;
        if (width == 0 || height == 0) {
    ...
    private void doInit(AngleSurfaceView view, int width, int height, int resourceId, int cropLeft,
            ...
            try {
                ...
                try {
                    ...
                    Log.e("AngleTextureEngine",
                            "loadTexture::InputStream.close error: " + e.getMessage(), e);
                }
            }
        } else {
            roWidth = width;
     ...
     * @param cropHeight
     */
    public void changeLayout(int width, int height, int resourceId, int cropLeft, int cropTop,
     ...
     */
    public void changeLayout(int width, int height, int resourceId, int cropLeft, int cropTop,
            int cropWidth, int cropHeight, int frameCount, int frameColumns) {
        roWidth = width;
        roHeight = height;
        roCropLeft = cropLeft;
        roCropWidth = cropWidth;
